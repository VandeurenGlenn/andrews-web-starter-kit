var BackedUtils = (function (exports) {
  'use strict';
  ...
  */
   ...
   * @return {object} merge result
   */
   const loadScript = (src, method = 'async', type) => {
    ...
    * @return {promise}
    */
    const loadModule = (src, method = 'async') => {
    ...
    */
   const fireEvent = (type='', detail=null, target=HTMLElement) => {
  ...
  exports.shouldRegister = shouldRegister;
